...
(function () {
    ...
    Gauge = (function (superClass) {
        ...
        Gauge.prototype.renderStaticLabels = function (staticLabels, w, h, radius) {
            ...
            this.ctx.fillText('Ã“timo', 200, 30);
            ...
            for (j = 0, len = ref.length; j < len; j++) {
                ...
                if (value.label !== void 0) {
                    if ((!this.options.limitMin || value >= this.minValue) && (!this.options.limitMax || value <= this.maxValue)) {
                        ...
                        this.ctx.fillText(formatNumber(value.label, staticLabels.fractionDigits), 0, -radius - this.lineWidth / 3);
                        this.ctx.rotate(-rotationAngle);
                    }
                } else {
                    if ((!this.options.limitMin || value >= this.minValue) && (!this.options.limitMax || value <= this.maxValue)) {
                        ...
                        this.ctx.rotate(rotationAngle);
                        this.ctx.fillText(formatNumber(value, staticLabels.fractionDigits), 0, -radius - this.lineWidth / 3);
                        this.ctx.rotate(-rotationAngle);
                    }
                }
            }
